# 🎯 ABIDB Web (Arena Breakout Infinite - Database)
...
* 📊 **Damage Drop-off Charts:** Visual representation of damage and effective range.
* ⚖️ **Weapon Comparison:** Add up to 15 weapons to a cart and compare their absolute stats side-by-side.
